        ...
        <React.Fragment>
            <Grid container direction={"column"}
                ...
                <Grid container item>
                    <Grid container direction="row" paddingTop="32px" xs={12}>
                        ...
                        <div className="sig_btn" onClick={()=>navigate("/v2/signup")}>
                    ...
                    <Grid container marginTop={"100px"} direction={"row"}>
                        ...
                        <Grid container item xs={4} fontSize="60px" fontWeight={"500"}>
                            ...
                            <Grid item>
                                ...
                                <img src={Play}  onClick={()=>openInNewTab("https://play.google.com/store/apps/details?id=com.teachingaura.student")} width={"80%"}/>
                                {/*</IconButton>*/}
                            </Grid>
                        </Grid>
            ...
            <footer className="foot_box">
                ...
                <div className="box_cont_foot">
                    ...
                    <span>+91 8287718282 <label>support@teachingaura.com </label></span>
                </div>
