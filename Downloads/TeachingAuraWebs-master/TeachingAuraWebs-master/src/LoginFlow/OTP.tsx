...
function OTP() {
    ...
    function signIn() {
        window.confirmationResult.confirm(otp).then((result) => {
            ...
            console.debug("User signed in successfully : " + user.uid);
            console.info("User role is : " + signInDetails.role);

            if(signInDetails.role == "admin") {
                client.post("/institute", {id: user.uid, ownerContactNumber: user.phoneNumber,instituteName:"New Institute"}).then((response) => {
                ...
                client.post("/student", {id: user.uid,contactNumber:user.phoneNumber,name:"New Student"}).then((response) => {
                ...
                client.post("/teacher", {id: user.uid,contactNumber:user.phoneNumber,name:"New Teacher"}).then((response) => {
