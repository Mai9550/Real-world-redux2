...
export const UploadStudyMaterial = (props) => {
    ...
    const createStudyMaterial = (list) => {
        ...
        client.post(`/institute/${instituteId}/batch/${props.batchId}/studyMaterial`, {
            id: generateId(),
            name: "",
    ...
    return (
        <label
            ...
            className="btnx_hede"
            style={{marginBottom: 0, marginLeft: 0, marginRight: 0, background: 'transparent',padding:0}}
        >
            <Input
                accept="*"
            ...
            <Button
                ...
                component="span"
                className="btnx_hede"
                style={{marginLeft: 0, padding: 20,borderRadius:20, background: "#FF3998"}}
            >
                <PlusIc color={"white"}/>
                {/* <CreateNewFolderIcon/> */}
